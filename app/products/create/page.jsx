        ...
        <>
            ...
            <form onSubmit={validateData}>
                <div className='flex flex-col gap-3 '>
                    ...
                    <input type="text" value={productData.name} onChange={setValueToState} name='name' placeholder='Agrega un ejerciocio' className={`text-center text-black font-semibold`} />
                    <p className='text-rose-600'>{errors.name}</p>
                    <label htmlFor="price">Rondas y Repeticiones</label>
                    <input type="text" value={productData.price} onChange={setValueToState} name='price' placeholder='Ron - Reps' className='text-center text-black font-semibold' />
                    ...
                    <label htmlFor="category">Zona Muscular</label>
                    <input type="text" value={productData.category} onChange={setValueToState} name='category' placeholder='Zona Muscular' className='text-center text-black font-semibold' />
                    ...
                    <button type="submit" className='p-2 bg-slate-500 text-white rounded-lg hover:bg-slate-800'>Añadir Ejercicio</button>
                </div>
