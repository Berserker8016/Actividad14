    ...
    return (
        <div className="flex justify-center content-center items-center flex-col min-h-screen bg-gray-800 size-full">
            ...
            >
                ...
                />
                <p className="text-center text-white font-semibold">Rondas y Repeticiones:</p>
                <label htmlFor="price">
                ...
                <input
                    ...
                    className="rounded-md p-2 bg-slate-500"
                />
                <label htmlFor="category" className="text-center text-white font-semibold">Zona Muscular:</label>
                <input
                    type="text"
                    name="category"
